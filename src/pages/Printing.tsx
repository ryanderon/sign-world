...
const printingCategories = [
  {
    ...
    image: "https://images.unsplash.com/photo-1562654501-a0ccc0fc1d67?w=600&h=400&fit=crop",
    icon: (
...
const portfolioImages = [
  { src: "https://images.unsplash.com/photo-1586339949916-3e9457bef6d3?w=400&h=300&fit=crop", alt: "Offset Printing" },
  { src: "https://images.unsplash.com/photo-1562654501-a0ccc0fc1d67?w=400&h=300&fit=crop", alt: "Digital Printing" },
  { src: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&h=300&fit=crop", alt: "Installation" },
  { src: "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400&h=300&fit=crop", alt: "Large Format" },
  { src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop", alt: "Vehicle Wrap" },
  { src: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?w=400&h=300&fit=crop", alt: "Banner Print" },
];
  ...
  return (
    <div ref={ref} className="relative">
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <span className="text-subheading mb-4 block">{t("printing.sectionTitle")}</span>
            <h1 className="text-display mb-6 text-primary">
              {t("printing.heading")} <span className="text-gradient-warm">{t("printing.headingHighlight")}</span>
            </h1>
      ...
      <section id="categories" className="py-20 md:py-28 bg-surface">
        <div className="container">
          <SectionHeader
            ...
            heading={<>{t("printing.categories.heading")} <span className="text-gradient">{t("printing.categories.headingHighlight")}</span></>}
            ...
            {printingCategories.map((category) => (
              <article key={category.id} className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={category.image}
                    alt={t(`printing.categories.items.${category.translationKey}.title`)}
                ...
                <div className="p-6">
                  <h3 className="font-display text-xl font-bold text-primary mb-2">
                    {t(`printing.categories.items.${category.translationKey}.title`)}
                  </h3>
                  <p className="text-text-muted text-sm mb-4 leading-relaxed">
                    {t(`printing.categories.items.${category.translationKey}.desc`)}
                  </p>

                  <ul className="space-y-2 mb-6">
                    {(t(`printing.categories.items.${category.translationKey}.features`, { returnObjects: true }) as string[]).map((feature) => (
      ...
      <section className="py-20 md:py-28">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-subheading mb-4 block">{t("printing.whyUs.sectionTitle")}</span>
              <h2 className="text-heading text-primary mb-6">
                {t("printing.whyUs.heading")} <span className="text-gradient-warm">{t("printing.whyUs.headingHighlight")}</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {["fastTurnaround", "colorAccuracy", "ecoFriendly", "noMinimum"].map((key) => (
                  <div key={key} className="flex items-start gap-3 p-4 bg-surface rounded-xl">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(135deg, #f97316 0%, #ec4899 100%)' }}>
      ...
      <section id="contact" className="py-20 md:py-28 bg-white">
        <div className="container">
          <div className="relative rounded-3xl overflow-hidden p-10 md:p-16" style={{ background: 'linear-gradient(135deg, #f97316 0%, #ec4899 100%)' }}>
